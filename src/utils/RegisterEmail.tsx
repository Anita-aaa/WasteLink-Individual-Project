                    ...
                    <Body className=" bg-white text-black my-auto mx-auto font-sans">
                        <Container className="border border-solid  border-black/50 rounded my-[40px] mx-auto p-[20px] w-[465px]">
                            ...
                            <Section className="text-center mt-[32px] mb-[32px]">
                                <Button className=" bg-red-600 p-4 rounded text-white text-[12px] font-semibold w-full no-underline text-center" href={VerifyLink}>
                                    {type == "VERIFY_USER" ? "Verify Email" : "Reset Password"}
                                </Button>
                            </Section>
                            <Text className=" text-white text-[14px] leading-[24px]">
                                or copy and paste this URL into your browser:{" "}
                                <Link href={VerifyLink} className="text-red-600 no-underline">
                                    {VerifyLink}
                                </Link>
                            </Text>
                            <Text>Once you&apos;re in, get ready to embark on a waste-busting adventure like no other. Here&apos;s what you can expect:</Text>
                            <Text>
                                <strong className=" text-red-400">Dump & Earn Coupons </strong> : Every time you dump waste responsibly, you&apos;ll earn coupons that you can redeem for exciting rewards. It&apos;s like leveling up in a game, but with real-world benefits!
                            </Text>
                            <Text>
                                <strong className=" text-red-600">Compete with Friends:</strong>Challenge your friends and family to see who can dump the most waste and earn the most rewards. Let&apos;s turn waste management into a friendly competition!
                            </Text>
                            <Text>
                                <strong className=" text-red-600">Exclusive Rewards</strong>From discounts at local businesses to eco-friendly goodies, our rewards catalog is filled with perks that make waste management worth your while.
                            </Text>
                            <Text>
                                <strong className=" text-red-600">Track Your Progress:</strong> Keep an eye on your waste-dumping stats and see how you&apos;re making a difference in the world. You&apos;ll be amazed at how much of an impact you can have!
                            </Text>
