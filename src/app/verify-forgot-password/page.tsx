                ...
                <section className="flex min-h-[90vh] justify-center items-center">
                    <div className="  shadow-md shadow-black/10 border-2 border-black/10 w-full m-4 md:m-auto p-4 rounded-lg">
                        ...
                        <form autoComplete="false" className="flex flex-col gap-2" onSubmit={handleVerifyResetPassword}>
                            ...
                            <div className={`flex justify-between items-center border-2 rounded-lg  ${passwordMismatch ? "border-red-500" : "border-black/20"} focus:border-red-600 duration-200 p-2 `}>
                            ...
                            {loading ? (
                                ...
                                <button className={` p-3 ${password && confirmPassword != "" && password === confirmPassword ? "bg-red-600 text-white cursor-pointer" : "bg-black/30 text-white cursor-not-allowed"} rounded-lg mt-3 font-semibold duration-200  `} disabled={password && confirmPassword != "" && password && confirmPassword.length > 8 && password ? false : true}>
                                    Reset
                                </button>
                            )}
                        </form>
