    ...
    return (
        <div className="flex relative flex-col  mt-4 w-full mb-40">
            ...
            <div>
                ...
                <button onClick={capturePhoto} className=" bg-red-600 w-16 h-16 m-auto rounded-full  flex gap-3 items-center text-center justify-center  text-3xl font-bold text-white mt-7  p-4">
                    ...
                    {aiData && (
                        <div className=" bg-black/5 shadow-lg w-full mt-12 mb-28 rounded-2xl border-2 border-black/10">
                            <div className="flex flex-col gap-4  p-4">
                                ...
                                {demo}
                                <Link href={`/dump-waste?recycle=${parseFloat(aiData.recyclable_probability) > 70 ? true : false}&&wasteName=${aiData.waste_name}&&wasteType=${aiData.waste_type}&&material=${aiData.material}&&totalwaste=${aiData.total_waste_count}`} className=" flex justify-center items-center gap-3 bg-red-600 text-white p-5 rounded-lg">
                                    <Trash />
                                    Dump waste{" "}
                                </Link>
                            </div>
