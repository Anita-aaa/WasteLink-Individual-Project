        ...
        <>
            {loading ? (
                ...
                <div className={`${lato.className} flex flex-col  min-h-[90vh]`}>
                    ...
                    <div className=" bg-red-600 rounded-3xl w-full h-48 mt-12">
                    ...
                    <button onClick={logout} className="flex items-center justify-center gap-4 text-lg font-semibold w-full p-4 rounded-lg mt-5  text-white bg-red-600">
                        <LogOut /> Logout
                    </button>
                </div>
            )}
