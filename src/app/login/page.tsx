            ...
            <section className="flex min-h-[88vh] justify-center items-center">
                <div className=" border-black/10 border-2  shadow-lg shadow-black/10   w-full  m-4 md:m-auto p-4 rounded-lg">
                    ...
                    <form autoComplete="false" className="flex flex-col gap-2" onSubmit={handleLogin}>
                        ...
                        <input type="email" placeholder="Email" onChange={(e) => setEmail(e.target.value)} className=" bg-transparent fill-none border-2  border-black/20 duration-200 focus:border-red-700 text-black p-2 focus:outline-none  rounded-lg  " autoComplete="off" />
                        ...
                        {loading ? (
                            ...
                            <button className={` p-3 ${email && password != "" ? "bg-red-600 text-white cursor-pointer" : "bg-black/30 text-white  cursor-not-allowed"} rounded-lg mt-3 font-semibold duration-200"} `} disabled={email && password != "" ? false : true}>
                                Login
                            </button>
                        )}
