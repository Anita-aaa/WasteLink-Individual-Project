...
const Contact = () => {
    ...
    return (
        <form autoComplete="off" ref={form} onSubmit={sendEmail} className="flex flex-col gap-3 mb-44 ">
            <div className="flex flex-col ">
                <h1 className=" font-semibold  opacity-90 text-red-900 text-2xl tracking-wide">Report an Incident</h1>
                <div className="flex flex-col">
                    ...
                    <select name="wasteType" className="border-2 border-black/40 p-3 mt-5 rounded-lg bg-transparent">
  ...
  <option value="Metal">Metal</option>
                    ...
                    {loading ? (
                        <button className="flex justify-center items-center bg-red-500 text-white gap-3 p-4 " disabled>
                            <ScaleLoader color="#fff" className=" scale-50" /> Processing.....
                        </button>
                    ) : (
                        <button className="flex justify-center items-center gap-3 bg-red-600 text-white rounded-lg p-4">
                            <MailPlus />
                            Report
                        </button>
                    )}
